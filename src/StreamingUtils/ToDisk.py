...
if __name__ == '__main__':
    ...
    dataFile = '../../train_data_int.txt'  #mem data for uText bText
    inFile = '../../train_data_int.txt'  #to generate for
    outFile = '../../epoch_train_1.txt' #output 
    batch_size = 10
    max_len = 1000
    num_workers = 1
    timeout = 400.0 #1 sec for 30 cpus 100 batch size, larger if larger batch
    ...
    with open(outFile, 'w',encoding="utf-8") as gout:
        nw = 0
