...
def test(sess, dcmf, batch_iter):
    ...
    while True:
        ...
        try:
            #read the values
            _, _, rList, retUTextInt, retBTextInt   = next(batch_iter)
        except StopIteration:
            #end of data
            break
...
if __name__ == '__main__':
    ...
    trainep = '../mydata/train_epochs'
    valep = '../mydata/val_epochs'
    testep = '../mydata/test_epochs'
    numfilters = 100
    ...
    transLayers = 2
    savedir = '../mydata/tnet_models/'

    model_chk = "../mydata/tnet_models/1_9_model.ckpt.data-00000-of-00001"
    ...
    sess = tf.Session(config=cfg)
    print("restoring")
    dcmf.restore_model(sess,model_chk,emb)
    # try:
    # try:
    #     train(dcmf, savedir)
    # except Exception:
